...
description: Internal guidance for presenting AI helper output back to the user
user-invocable: false
---

# AI Result Handling

When the helper returns AI output:
- Preserve the helper's verdict, summary, findings, and next steps structure.
- For review output, present findings first and keep them ordered by severity.
- Use the file paths and line numbers exactly as the helper reports them.
- Preserve evidence boundaries. If the AI marked something as an inference, uncertainty, or follow-up question, keep that distinction.
...
- If the helper reports that setup or authentication is required, direct the user to `/ai:setup` and do not improvise alternate auth flows.
